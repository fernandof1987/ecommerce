            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @else
                        ...
                        <form action="/admin/produtos/store" method="post" class="form">
                            {{ csrf_field() }}
                            <input type="hidden" name="Imagem" value="NULL" />
                            ...
                            <input type="number" name="PrecoCusto" class="form-control" placeholder="Preço Custo"><br />
                            <input type="number" name="PrecoVenda" class="form-control" placeholder="Preço Venda"><br />
                            <input type="number" name="Peso"       class="form-control" placeholder="Peso"><br />
